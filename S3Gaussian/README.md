...
> [Nan Huang](https://github.com/nnanhuang)\*<sup>§</sup>, [Xiaobao Wei](https://ucwxb.github.io/)\*, [Wenzhao Zheng](https://wzzheng.net/)<sup>†</sup>, Pengju An, [Ming Lu](https://lu-m13.github.io/), [Wei Zhan](https://zhanwei.site/), [Masayoshi Tomizuka](https://me.berkeley.edu/people/masayoshi-tomizuka/), [Kurt Keutzer](https://people.eecs.berkeley.edu/~keutzer/), [Shanghang Zhang](https://www.shanghangzhang.com/)<sup>‡</sup>

\* Equal contribution § Work done while interning at UC Berkeley † Project leader ‡ Corresponding author
...
```
python train.py -s /mnt/ljy/EmerNeRF/data/waymo/processed/dynamic32/training/094 --port 6017 --expname "test" --model_path $model_path 
```
...
```
python train.py -s /mnt/ljy/EmerNeRF/data/waymo/processed/dynamic32/training/094 --expname "waymo_novel" --configs "arguments/nvs.py" --prior_checkpoint /mnt/ljy/S3Gaussian/output/waymo_dynamic32/chkpnt_fine_50000.pth
```
...
```python
python train.py -s /mnt/ljy/EmerNeRF/data/waymo/processed/dynamic32/training/094 --port 6017 --expname "waymo_visualize" --start_checkpoint "/mnt/ljy/S3Gaussian/output/waymo_dynamic32/chkpnt_fine_50000.pth"  --eval_only
```
