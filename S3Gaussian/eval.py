...
from scene.FAGS import frequency_loss
...
def scene_reconstruction(dataset, opt, hyper, pipe, testing_iterations, saving_iterations, 
    ...
    for iteration in range(first_iter, final_iter+1):        
        ...
        if stage == 'fine' and args.feat_head:
            ...
            loss += loss_feat
        if stage=='fine'and args.use_fags:
            freq_loss = frequency_loss(image_tensor, gt_image_tensor)
            loss += opt.lambda_freq * freq_loss
